...
╭──〔 COMANDOS ESPECIAIS 〕──⪩
│ 𖧈∘̥⸽🎵⃟ ${prefix}shazam - Identifica música de áudio
│ 𖧈∘̥⸽🔫⃟ ${prefix}arma [nome] - Buscar armas
│ 𖧈∘̥⸽📖⃟ ${prefix}dicionario [palavra] - Buscar no dicionário
...
│ 𖧈∘̥⸽💡⃟ ${prefix}conselho1 - Conselho do dia
│ 𖧈∘̥⸽💡⃟ ${prefix}conselho2 - Conselho motivacional
...
│┊𖥨ํ∘̥⃟⸽⃟🎐￫ ${prefix}bam @user
│┊𖥨ํ∘̥⃟⸽⃟🎐￫ ${prefix}cafune @user
